...
from PyQt6.QtWidgets import QCheckBox, QLabel, QLineEdit, QTextEdit
...
class LogMixin:
    ...
    def _init_log_components(self) -> None:
        ...
        self.detailed_log: QTextEdit | None = QTextEdit()
        self._log_entries: list[dict[str, str]] = []
        self._filtered_log_entries: list[dict[str, str]] = []
        self.log_status_label: QLabel | None = QLabel()
    ...
    def add_log_entry(self, message: str, level: str = "Информация") -> None:
        ...
        log_entry: dict[str, str] = {"timestamp": timestamp, "level": level, "message": message}
    ...
    def _filter_log_entries(self) -> None:
        ...
        search_text: str | None = getattr(self, "_search_text", None)
        if not search_text:
            self._filtered_log_entries = self._log_entries.copy()
            return
        ...
        self._filtered_log_entries = [
            ...
            if search_text in entry["message"].lower() or search_text in entry["level"].lower()
        ]
            ...
            for line in lines:
                ...
                if line.startswith("[") and "] [" in line:
                    ...
                    if len(parts) >= 3:
                        ...
                        level: str = parts[1]
                        message: str = parts[2].removesuffix("]")
