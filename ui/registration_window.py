...
from PyQt6.QtWidgets import QHBoxLayout, QLabel, QLineEdit, QMessageBox, QPushButton, QToolButton, QVBoxLayout, QWidget
...
class RegistrationWindow(QWidget):
    def __init__(self, parent_login: QWidget | None = None):
        super().__init__()
    ...
    def _create_password_input():
        ...
        def toggle_password():
            line_edit.setEchoMode(
                QLineEdit.EchoMode.Normal if toggle_button.isChecked() else QLineEdit.EchoMode.Password
            )
    ...
    def on_register(self):
        ...
        try:
            ...
            if self.parent_login and hasattr(self.parent_login, "parent"):
                ...
                parent = parent_obj if isinstance(parent_obj, QWidget) else None
