...
from utils.security import validate_email_format, validate_password_strength
...
class UserModel:
    ...
    @staticmethod
    def _get_cached_user(key: str) -> dict[str, Any] | None:
    ...
    def _validate_registration_data(username: str, email: str, password: str) -> tuple[bool, str]:
        ...
        try:
            ...
            if password_score < 3:
                return (
                    False,
                    "Пароль слишком слабый. Используйте минимум 8 символов, "
                    "включая заглавные буквы, цифры и специальные символы.",
                )
    ...
    def authenticate_user(self, username: str, password: str) -> tuple[bool, dict[str, Any] | None, str | None]:
    ...
    def get_user_cache_stats() -> dict[str, int]:
        ...
        return {"cache_size": len(_user_cache), "cache_entries": len(_cache_timestamps)}
