...
# Типы уязвимостей
VULNERABILITY_TYPES = {"sql": "SQL Injection", "xss": "Cross-Site Scripting", "csrf": "Cross-Site Request Forgery"}

# Уровни логирования
LOG_LEVELS = {"DEBUG": 10, "INFO": 20, "WARNING": 30, "ERROR": 40, "CRITICAL": 50}

# Настройки базы данных
DB_SETTINGS = {"timeout": 20, "max_connections": 10, "backup_count": 5, "max_size_mb": 10}

# Настройки шифрования
ENCRYPTION_SETTINGS = {"algorithm": "AES-256-GCM", "key_length": 32, "salt_length": 16}

# Настройки сканера
SCANNER_SETTINGS = {"max_payloads_per_url": 40, "max_forms_per_url": 20, "request_delay": 0.1, "retry_attempts": 3}
...
def get_app_info():
    ...
    return {"name": APP_NAME, "version": APP_VERSION, "author": __author__, "email": __email__}
