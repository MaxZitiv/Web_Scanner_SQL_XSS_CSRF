...
class PerformanceMonitor:
    ...
    def get_system_info(self) -> dict[str, Any]:
        ...
        # Проверяем кэш
        if current_time - self._system_info_cache_time < self._system_info_ttl and self._system_info_cache:
...
class ResourceManager:
    ...
    def register_resource(self, name: str, resource: Any, cleanup_func: Callable[[Any], Any] | None = None) -> None:
...
def optimize_memory_usage() -> dict[str, Any]:
    ...
    try:
        ...
        return {"objects_collected": collected, "memory_stats": memory_stats}
    except Exception as e:
